...
public class TempConvertorWindow extends JFrame
{
    ...
    private void buildPanel()
    {
       ...
       //create button listener 
        convertToFah.addActionListener(new convertToFahListerner());
        convertToCel.addActionListener(new convertToCelListener());
