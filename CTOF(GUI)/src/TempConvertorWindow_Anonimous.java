...
public class TempConvertorWindow_Anonimous extends JFrame
{
    ...
    public TempConvertorWindow_Anonimous()
    {
       //create title
    ...
    private void buildPanel()
    {
       ...
       //create button listener 
        convertToFah.addActionListener(new ActionListener()
         {
        ...
        convertToCel.addActionListener(new ActionListener()
         {
           public void actionPerformed(ActionEvent e) 
           {
            double celsius, fahrenheit;
 ...
 /* private class convertToCelListener implements ActionListener
   ...
   */ 
    ...
    {
        new TempConvertorWindow_Anonimous();
    }
}