...
import java.util.concurrent.ThreadLocalRandom;
    ...
    public void run() {
        ...
        try {
            if(!this.isUDPPort()){
                System.out.println("UDP Server: Listening on UDP port: " +  this.portNumber);
            ...
            System.out.println("UDP Server: SOCKET ERROR");
        } catch (IOException ex) {
            System.out.println("UDP Server: PACKET ERROR");
        }
    }    
    ...
    private void sendWelcomeMessage() {
        try{
            ...
            DatagramPacket packet = new DatagramPacket(buffer, buffer.length, InetAddress.getLocalHost(),clientPort);
            System.out.println("UDP Server: sending UDP packet: " +message);
            DatagramSocket udpSocket = new DatagramSocket(this.udp_port);
            udpSocket.send(packet);
            @SuppressWarnings("unused")
			UDP_Handler udpPort = new UDP_Handler("UDP_Server:",udpSocket,this.udp_port, this.clientPort);
