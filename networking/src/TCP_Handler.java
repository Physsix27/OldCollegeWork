...
public class TCP_Handler implements Runnable {
    ...
    @Override
    public void run() {
    	//JOptionPane.showMessageDialog(null, "TCP Server: Listening on TCP port: " + portNumber);
        System.out.println("TCP Server: Listening on TCP port: " + portNumber);
        try {
    ...
    private void handler(Socket client) {
        try{
            ...
            System.out.println("TCP Server: received stream: " + inputLine);
            
            out.println ("EchoServer: " + inputLine + '\n'); 
            System.out.println("TCP Server: sending TCP stream: I got your "+ inputLine);
