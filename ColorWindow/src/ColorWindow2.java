...
public class ColorWindow2 extends JFrame
{
   ...
   public ColorWindow2()
   {
      ...
      redButton.addActionListener(new action2Listener());
      blueButton.addActionListener(new action2Listener());
      yellowButton.addActionListener(new action2Listener());
   ...
   {
       ColorWindow2 colorWindow = new ColorWindow2();
   }
}